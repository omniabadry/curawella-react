    ...
    <>
      <div className="container-fluid" style={{ clear: "both" }}>
        <div className="row" id="footer">
          ...
          <div className="col-xl-3 d-xl-block col-lg-3 d-lg-block d-md-none d-sm-none d-none text-left">
            <p>
              <h3>{t("Follow us")}</h3>
            </p>
            <br /> <br />
      ...
      <div className="container-fluid" style={{ clear: "both" }}>
        <div className="row" id="footer">
          ...
          >
            ...
            <a id="footerBrand2">CURAWELLA</a>
          </div>
          <div className=" d-xl-none d-lg-none col-md-12 d-md-block col-12 d-sm-block text-center mt-2 ">
            <p>
              <h3>{t("Follow us")}</h3>
            </p>
            <br />
          ...
          <div className=" d-xl-none d-lg-none col-md-12 d-md-block col-12 d-sm-block text-center mt-4">
            <p>
              <h3>{t("Download our apps")}</h3>
            </p>
            ...
            <div className="row">
              <div className="d-xl-none d-lg-none col-md-12 col-12">
                <img
                  src="/images/google-play-store-button.png"
                  className="googlePlay2"
                />
              </div>
              <div className="d-xl-none d-lg-none col-md-12 col-12">
                <img src="/images/app_store_icon.png" className="googlePlay2" />
              </div>
            </div>
          </div>
        </div>
