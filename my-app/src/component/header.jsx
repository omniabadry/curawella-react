   ...
   useEffect(() => {
     ...
     window.onscroll = function () {
       ...
       if (prevScrollpos > currentScrollPos) {
         document.getElementById("divNavbar").style.top = "0";
       } else {
         document.getElementById("divNavbar").style.top = "-200px";
       }
  ...
  return (
    <div id="divNavbar">
      <nav
        ...
        id="Navbar"
      >
        <a className="navbar-brand" href="#" style={{ color: "#00c3ec",display: "flex"}}>
